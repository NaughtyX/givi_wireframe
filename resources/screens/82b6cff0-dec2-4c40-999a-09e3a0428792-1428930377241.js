jQuery("#simulation")
  .on("click", ".s-82b6cff0-dec2-4c40-999a-09e3a0428792 .click", function(event, data) {
    ...
    if(jFirer.is("#s-Label_58")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-minus-red-line_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-minus-red-line_2")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-minus-red-line_3")) {
      cases = [
        {
          "blocks": [
            {
