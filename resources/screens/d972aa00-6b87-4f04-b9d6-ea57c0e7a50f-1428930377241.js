jQuery("#simulation")
  .on("click", ".s-d972aa00-6b87-4f04-b9d6-ea57c0e7a50f .click", function(event, data) {
  ...
  .on("focusin", ".s-d972aa00-6b87-4f04-b9d6-ea57c0e7a50f .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
