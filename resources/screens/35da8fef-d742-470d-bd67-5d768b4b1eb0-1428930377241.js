jQuery("#simulation")
  .on("click", ".s-35da8fef-d742-470d-bd67-5d768b4b1eb0 .click", function(event, data) {
  ...
  .on("pageload", ".s-35da8fef-d742-470d-bd67-5d768b4b1eb0 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
